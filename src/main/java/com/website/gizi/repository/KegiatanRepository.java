...
public interface KegiatanRepository extends JpaRepository<Kegiatan,Long> {
    ...
    @Query(value = "SELECT * from kegiatan a left join kegiatan_rekapitulasi b on a.id = b.kegiatan_id where a.aktor_id =:ida AND a.tanggal_kegiatan =:waktu and b.rekapitulasi_id is null ",nativeQuery = true)
