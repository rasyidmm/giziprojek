...
public interface TargetPenilaianRepository extends JpaRepository<TargetPenilaian, Long> {
    ...
    public List<TargetPenilaian> findAllByRekapitulasiAndVolNilaiSkorTargetIsZero(@Param("idr") long idr);
    ...
    public List<TargetPenilaian> findAllByRekapitulasiAndVolNilaiSkorTargetNotZero(@Param("idr") long idr);
